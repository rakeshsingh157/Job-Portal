...
async function fetchPosts() {
    try {
        // Show loading state
        document.getElementById('postsGrid').innerHTML = '<div class="empty-state"><div class="empty-state-icon"><i class="fas fa-spinner fa-spin"></i></div><p>Loading posts...</p></div>';
